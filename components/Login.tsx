...
const Login: React.FC<Props> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
       {/* Background Elements */}
       <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-cyan-600/20 rounded-full blur-[100px]"></div>
       <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[100px]"></div>

       <div className="bg-slate-900/80 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl w-full max-w-md animate-in zoom-in-95 duration-500 relative z-10">
          <div className="text-center mb-8">
             ...
             <p className="text-slate-400 text-sm">سامانه جامع مدیریت سلامت شغلی</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
             <div className="space-y-2">
                 <label className="text-slate-300 text-xs font-bold mr-1">نام کاربری</label>
                 <div className="relative">
                     ...
                     <input 
                        ...
                        className="w-full bg-slate-800 border border-white/10 rounded-xl py-3 pr-10 pl-4 text-white focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all"
             ...
             <div className="space-y-2">
                 <label className="text-slate-300 text-xs font-bold mr-1">رمز عبور</label>
                 <div className="relative">
