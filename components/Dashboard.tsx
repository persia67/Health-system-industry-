...
const Dashboard: React.FC<DashboardProps> = ({ workers, onViewCritical, isDark }) => {
  // Aggregate stats
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {/* Compliance Bars */}
      <div className="bg-white dark:bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-none">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">شاخص های انطباق (Compliance)</h3>
          <div className="space-y-6">
            <div>
              <div className="flex justify-between text-slate-900 dark:text-white mb-2 text-sm font-medium">
                <span>استاندارد HSE</span>
                <span className="text-emerald-500 dark:text-emerald-400">85/90</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-slate-900 dark:text-white mb-2 text-sm font-medium">
                ...
                <span className="text-amber-500 dark:text-amber-400">78/85</span>
              </div>
              <div className="w-full bg-slate-200 dark:bg-slate-700/50 rounded-full h-3 overflow-hidden">
            ...
            <div>
              <div className="flex justify-between text-slate-900 dark:text-white mb-2 text-sm font-medium">
                <span>ISO 45001</span>
                <span className="text-cyan-500 dark:text-cyan-400">92/95</span>
              </div>
              <div className="w-full bg-slate-200 dark:bg-slate-700/50 rounded-full h-3 overflow-hidden">
